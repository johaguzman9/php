...
if ($_POST) {
    if (isset($_POST["btnGuardar"])) {
        ...
        $tventa->cargarFormulario($_REQUEST);
        $venta->eliminar();
          ...
          <h1 class="h3 mb-4 text-gray-800">Venta</h1>
            ...
            <div class="row">
                ...
                <div class="col-6 form-group">
                    ...
                    <select required="" class="form-control selectpicker" data-live-search="true" name="lstCliente" id="lstCliente">
                        ...
                        <?php foreach($aClientes as $cliente): ?>
                            <?php if($cliente->idtcliente == $venta->fk_idtcliente): ?>
                                <option selected value="<?php echo $cliente->idcliente;?>"><?php echo $cliente->nombre; ?></option>
                            <?php else: ?>
                                <option value="<?php echo $cliente->idtcliente;?>"><?php echo $cliente->nombre; ?></option>
                            <?php endif; ?>
                        <?php endforeach; ?>
                    </select>
                </div>
                ...
                <div class="col-6 form-group">
                    ...
                    <input type="text" class="form-control" name="txtPrecioUni" id="txtPrecioUni" value="" require>
                </div>
                <div class="col-6 form-group">
                    <label for="txtCantidad">Cantidad:</label>
                    <input type="text" class="form-control" name="txtCantidad" id="txtCantidad" value="" onchange="fCalcularTotal();" require>
                    <span id="msgStock" class="text-danger" style="display:none;">No hay stock suficiente</span>
                </div>
                <div class="col-6 form-group">
                    <label for="txtTotal">Total:</label>
                    <input type="text" class="form-control" name="txtTotal" id="txtTotal" value="" require>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
